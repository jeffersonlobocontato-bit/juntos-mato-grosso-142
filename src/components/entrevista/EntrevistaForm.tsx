...
// Indicadores pré-definidos por eixo temático (IDs dos 5 novos eixos)
const indicadoresPorEixo: Record<string, Array<{ value: string; label: string }>> = {
  ...
  // 2. Desenvolvimento Econômico Sustentável (Geração de Emprego e Renda)
  ...
  // 4. Gestão Pública Eficiente (Controlar)
  "e4000000-0000-0000-0000-000000000004": [
    { value: "transparencia", label: "Índice de transparência pública (%)" },
    { value: "eficiencia_fiscal", label: "Eficiência fiscal (receita/despesa)" },
    { value: "processos_digitais", label: "Processos administrativos digitalizados (%)" },
    { value: "tempo_resposta_cidadao", label: "Tempo médio de resposta ao cidadão (dias)" },
    { value: "servidores_capacitados", label: "Servidores capacitados por ano" },
    { value: "reducao_custos", label: "Redução de custos operacionais (%)" },
    { value: "licitacoes_eletronicas", label: "Licitações eletrônicas (%)" },
    { value: "satisfacao_cidadao", label: "Índice de satisfação do cidadão (%)" },
    { value: "compliance", label: "Índice de conformidade regulatória (%)" },
    { value: "parcerias_publico_privadas", label: "PPPs ativas" },
  ],
  ...
  "e5000000-0000-0000-0000-000000000005": [
    ...
    { value: "processos_corrupcao", label: "Processos de combate à corrupção concluídos" },
    { value: "recuperacao_ativos", label: "Valores recuperados de desvios (R$)" },
