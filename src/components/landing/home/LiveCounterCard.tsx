  ...
  return (
    <section className="relative z-10 container mx-auto px-4 md:px-8 lg:px-12 mt-4">
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary/90 p-8 md:p-12 shadow-card-float border border-primary/20"
      >
        ...
        <div className="relative grid md:grid-cols-[auto,1fr] gap-6 md:gap-10 items-center">
          <div className="flex items-center justify-center">
            <div className="relative">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-3xl bg-accent/20 backdrop-blur-sm flex items-center justify-center border border-accent/30">
          ...
          <div className="text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 text-primary-foreground/90 text-xs font-semibold uppercase tracking-wider mb-3">
              <TrendingUp className="w-3.5 h-3.5" />
              Contador ao vivo
            </div>
            <div className="font-display font-black text-5xl md:text-7xl leading-none text-primary-foreground mb-3">
              <span className="text-accent"><CountUp value={total} /></span>
            </div>
            <p className="text-primary-foreground/85 text-base md:text-lg font-medium max-w-xl">
