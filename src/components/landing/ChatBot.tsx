    ...
    setMessages([
      {
        id: "welcome",
        role: "assistant",
        content: `Olá, ${sanitizedData.name}! 👋 Sou o assistente virtual do Juntos Mato Grosso 142. Estou aqui para tirar suas dúvidas sobre a construção colaborativa do Plano de Governo do Mato Grosso.\n\nComo posso ajudar você hoje?`,
      },
    ]);
  };
          ...
          >
            ...
            <div className="bg-primary text-primary-foreground p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display font-bold">Assistente Juntos Mato Grosso 142</h3>
