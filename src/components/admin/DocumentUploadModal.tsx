  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!title.trim() || !docCategory) {
      toast({
        ...
        description: "Preencha título e categoria do documento",
        variant: "destructive"
      });
      return;
    }
    ...
    if (inputMode === 'text' && !content.trim()) {
      toast({
        ...
        description: "Cole ou digite o conteúdo do documento",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      if (inputMode === 'file' && file) {
        ...
        if (file.type === 'text/plain') {
          ...
          // For other file types, we store file info and reference
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={eixoId || "__none__"} onValueChange={(v) => setEixoId(v === "__none__" ? "" : v)}>
              <SelectTrigger>
                <SelectValue placeholder="Selecione o eixo (opcional)" />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>Região</Label>
              <Select value={regiao || "__none__"} onValueChange={(v) => {
                setRegiao(v === "__none__" ? "" : v);
                setMunicipioId("");
              }}>
                <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Descrição breve do documento (opcional)"
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="https://exemplo.com/documento (opcional)"
            />
          </div>
