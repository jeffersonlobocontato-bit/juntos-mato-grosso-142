...
const logoClara = "/marca/moro-gov-vice-2026-branco.png";
    ...
    <div style={{ fontFamily: "'Montserrat', sans-serif" }} className="bg-white">
      ...
      >
        ...
        <div className="relative container mx-auto px-6 py-14 md:py-20 max-w-6xl">
          <img src="/marca/moro-gov-vice-2026-branco.png" alt="Moro Governador — Vice Edson Vasconcelos" className="h-16 md:h-24 mb-10" />
