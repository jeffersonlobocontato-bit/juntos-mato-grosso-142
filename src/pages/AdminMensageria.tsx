...
Identificamos que você está há ${user.hours_inactive} horas sem atividade na plataforma Juntos Mato Grosso 142.
    ...
    try {
      const { error } = await supabase
        ...
        .insert({
          ...
          subject: 'Lembrete de atividade - Juntos Mato Grosso 142',
