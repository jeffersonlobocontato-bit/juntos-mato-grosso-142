...
DROP POLICY IF EXISTS "admin le resultados historicos" ON public.resultados_eleicoes_historicos;
...
DROP POLICY IF EXISTS "admin_master gerencia resultados historicos" ON public.resultados_eleicoes_historicos;
...
REVOKE ALL ON FUNCTION public.hist_combos() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.hist_combos() FROM anon;
...
REVOKE ALL ON FUNCTION public.hist_candidatos(int,int,int) FROM anon;
...
REVOKE ALL ON FUNCTION public.hist_municipios(int,int,int,text) FROM anon;
